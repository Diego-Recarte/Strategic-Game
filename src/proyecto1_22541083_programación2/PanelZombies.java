...
public class PanelZombies extends JDialog{
    ...
    PanelZombies(juego padre, personaje muerte, int equipo, int[] indexs, casilla[][] casillas){
    ...
    public void Inicializarbotones(juego padre, int equipo, personaje muerte, int [] indexs, casilla[][] casillas){
        ...
        atacar .addActionListener(e -> {
            ...
            if (vivo){
                padre.Asignarataque(indexs[0], indexs[1],casillas [indexs[0]][indexs[1]] ,0);
                this.dispose();
